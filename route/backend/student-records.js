...
router.get('/', (req,res) => {
    studRecords.find({})
    .then((o) => {
        res.render('../views/backend/stud-records', {o})
        // console.log(x)
    })
    .catch((u) => {
        console.log(u)
 ...
 router.get('/edit-student-records/:id', (req,res) => {
    studRecords.findOne({ rollnoo: req.params.id })
     .then((o) => {
         res.render('../views/backend/edit-stud-records', {o})
     })
     .catch((u) => {
         console.log(u)
     })
 ...
 router.put('/edit-student-records/:id', upload.single('recPhoto'), (req,res) => {
     if(req.file){
...
router.delete('/delete-student-records/:id',(req,res) => {
